...
declare -i length=21                                                #set frame length
declare -i px                                                       #set present x
declare -i py                                                       #set present y
declare -i ax=15                                                    #set addition for x
declare -i ay=6                                                     #set addition for y
p_f_list=`ls -1F | grep '/$'; ls -1F | grep '*$'; ls -1F | grep -v '[/*|]$'; ls -1F | grep '|$'`  #present file list < directory
